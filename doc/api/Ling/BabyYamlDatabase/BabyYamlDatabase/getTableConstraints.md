...
BabyYamlDatabase::getTableConstraints
================



BabyYamlDatabase::getTableConstraints — Returns the array corresponding to the given table's constraints.
...
protected [BabyYamlDatabase::getTableConstraints](https://github.com/lingtalfi/BabyYamlDatabase/blob/master/doc/api/Ling/BabyYamlDatabase/BabyYamlDatabase/getTableConstraints.md)(string $table) : array
...
Previous method: [setTableArray](https://github.com/lingtalfi/BabyYamlDatabase/blob/master/doc/api/Ling/BabyYamlDatabase/BabyYamlDatabase/setTableArray.md)<br>Next method: [getIndexByKey](https://github.com/lingtalfi/BabyYamlDatabase/blob/master/doc/api/Ling/BabyYamlDatabase/BabyYamlDatabase/getIndexByKey.md)<br>
